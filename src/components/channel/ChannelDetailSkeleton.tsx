        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative pb-4">
            ...
            <div className="absolute -top-12 left-0">
              <Skeleton className="h-24 w-24 rounded-full border-4 border-white bg-slate-200" />
            </div>
            ...
            <div className="mt-2 pt-10 space-y-2">
              ...
              <Skeleton className="h-4 w-2/3 max-w-md bg-slate-200" />
            </div>
            ...
            <div className="flex gap-3 mt-4 flex-wrap sm:flex-nowrap">
              {Array.from({ length: 4 }).map((_, i) => (
                <div
                  key={i}
                  className="flex-1 min-w-0 rounded-xl border border-slate-200 bg-white py-3 px-4"
                >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
        ...
        <div className="flex gap-1 p-1 bg-white border border-slate-200 rounded-xl w-fit">
          {Array.from({ length: 5 }).map((_, i) => (
            <Skeleton key={i} className="h-8 w-16 bg-slate-200" />
          ))}
        </div>
